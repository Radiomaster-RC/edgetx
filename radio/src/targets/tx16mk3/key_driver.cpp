...
{
  uint32_t result = 0;
  gpio_init(TRIM_T5_D, GPIO_IN_PU, GPIO_PIN_SPEED_LOW);
  gpio_init(TRIM_T5_U, GPIO_IN_PU, GPIO_PIN_SPEED_LOW);
...
#undef _TRIM
  if (gpio_read(TRIM_T5_D) == 0) result |= 1 << TR5D;
  if (gpio_read(TRIM_T5_U) == 0) result |= 1 << TR5U;
