...
#define TRIM_T5_D GPIO_PIN(GPIOH, 15)
#define TRIM_T5_U GPIO_PIN(GPIOH, 13)
...
#define ADC_GPIO_PIN_EXT3               LL_GPIO_PIN_0      // PB.00 POT3 Light Sensor
...
#define ADC_GPIOB_PINS                  (ADC_GPIO_PIN_POT2|ADC_GPIO_PIN_EXT3)
...
#define ADC_CHANNEL_EXT3                LL_ADC_CHANNEL_9    // ADC12_INP9    -> Light Sensor
...
#define I2C_B2                          I2C1
#define I2C_B2_SDA_GPIO                 GPIO_PIN(GPIOB, 9) // PD.13
#define I2C_B2_SCL_GPIO                 GPIO_PIN(GPIOB, 8) // PD.12
