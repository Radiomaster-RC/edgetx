...
//   LL_RCC_PLL3_SetM(48);//25MHz
  LL_RCC_PLL3_SetM(1);//24MHz

//   LL_RCC_PLL3_SetN(150);//25MHz
//   LL_RCC_PLL3_SetN(155);//25MHz
  LL_RCC_PLL3_SetN(4);//24MHz

  LL_RCC_PLL3_SetP(2);
  LL_RCC_PLL3_SetQ(2);

//   LL_RCC_PLL3_SetR(6);//25MHz
//   LL_RCC_PLL3_SetR(7);//27.5
  LL_RCC_PLL3_SetR(8); //24MHz
